...
image = Image.open('C:/Users/ckancel/Desktop\MBD/Financial Programing/Section 4/streamlit/img/finance.jpg')
st.image(image, caption='Finance')
...
def tab1():
    ...
    fig = make_subplots(rows=2, cols=1, shared_xaxes=True, 
               ...
               row_width=[0.2, 0.7])
    fig.add_trace(go.Scatter(x=data.index, y=data['Close'],name="Stock Trend",showlegend=True,fill='tozeroy', mode = 'markers', marker = {'color' : 'blue'}),row= 1,col = 1)
